...
func getValues(_ object: [String: Any]) -> [Any] {
    var resultVal = [Any]()
    
   object.map { $0
        print($0.value)
        resultVal.append($0.value)
    }
...
func argumentsT(_ number: inout Int, _ number2: inout Int) {
...
func genericArgs(inputOne: Any, inputTwo: Any) {
//do we know what type of parameters are we passing in?
...
genericArgs(inputOne: "44", inputTwo: 5)
